...
# define CONFIG_EWS_HTTP_CLIENTS 6
#endif
...
#if CONFIG_EWS_HTTP_CLIENTS == 0 || !defined(CONFIG_EWS_WS_CLIENTS)
...
#if CONFIG_EWS_HTTPS_CLIENTS == 0 || !defined(CONFIG_EWS_WSS_CLIENTS)
