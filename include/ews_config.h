...
#if !defined(CONFIG_EWS_WS_CLIENTS)
# define CONFIG_EWS_WS_CLIENTS 2
#endif
...
#if !defined(CONFIG_EWS_WSS_CLIENTS)
# define CONFIG_EWS_WSS_CLIENTS 0
#endif
...
#if !defined(CONFIG_EWS_WS_STACK_SIZE)
# define CONFIG_EWS_WS_STACK_SIZE 4096
#endif
